...
advanced_24 = pandas.read_csv('2023-2024 NBA Advanced Ratings.csv')
...
playoffs_24 = pandas.read_csv('2023-2024 NBA Playoff Advanced Ratings.csv')
...
for x in range(1951, 2024):
    ...
    file = str(x - 1) + "-" + str(x) + " NBA Advanced Ratings.csv"
    ...
    playoff_file = str(x - 1) + "-" + str(x) + " NBA Playoff Advanced Ratings.csv"
...
champions = pandas.read_csv('NBA champions.csv')
...
runner_up = pandas.read_csv('NBA champions.csv')
...
sns.lmplot(x = 'Comparative_Rating', y = 'RS_Win_Percentage', data = filter_advanced_24)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
...
sns.lmplot(x = 'Comparative_Rating', y = 'RS_Win_Percentage', data = pre_three_point)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
plt.ylabel("Regular Season Win Percentage")
...
sns.lmplot(x = 'Comparative_Rating', y = 'RS_Win_Percentage', data = post_three_point)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
plt.ylabel("Regular Season Win Percentage")
...
sns.lmplot(x = "Comparative_Rating", y = "Wins_Over_Expected", data=filter_advanced_24)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
...
sns.lmplot(x = "Comparative_Rating", y = "Wins_Over_Expected", data=pre_three_point)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
plt.ylabel("Wins Above Expected")
...
sns.lmplot(x = "Comparative_Rating", y = "Wins_Over_Expected", data=post_three_point)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
plt.ylabel("Wins Above Expected")
...
sns.lmplot(x = 'Comparative_Rating', y = 'PS_Win_Percentage', data = filter_playoffs_24)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
...
sns.lmplot(x = 'Comparative_Rating', y = 'PS_Win_Percentage', data=pre_three_playoffs)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
plt.ylabel("Post Season Win Percentage")
...
sns.lmplot(x = 'Comparative_Rating', y = 'PS_Win_Percentage', data = post_three_playoffs)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
plt.ylabel("Post Season Win Percentage")
...
sns.lmplot(x = 'Comparative_Rating', y = 'Wins_Over_Expected', data = filter_playoffs_24)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
...
sns.lmplot(x = 'Comparative_Rating', y = 'Wins_Over_Expected', data = pre_three_playoffs)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
plt.ylabel("Wins Over Expected")
...
sns.lmplot(x = 'Comparative_Rating', y = 'Wins_Over_Expected', data = post_three_playoffs)
plt.xlabel("Comparative Rating (ORTG Z Score - DRTG Z Score)")
plt.ylabel("Wins Over Expected")
